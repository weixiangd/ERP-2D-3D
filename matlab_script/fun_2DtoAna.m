function [ output_args ] = fun_2DtoAna( model,time_file,time_pause )
...
%1st HTTP POST THE 2D IMAGE (please replace the name of .jpg)
...
%2nd HTTP POST THE ANAGLYPH IMAGE (please replace the name of .jpg)
