function [ output_args ] = fun_3Dto2D( model,time_file,time_pause )
...
disp(modelname1);
data1.app.states = struct('load',struct('url',string(modelname1)));
...
disp(modelname);
data2.app.states = struct('load',struct('url',string(modelname)));
...
%Perform request at GET URL.
third_url = 'http://gdo-appsdev.dsi.ic.ac.uk:8084/set?id=2&url=http://gdo-appsdev.dsi.ic.ac.uk:9083/data/background/index.html?background=8b8b8bff';
