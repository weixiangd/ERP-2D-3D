function [ output_args ] = fun_Anato2D( model,time_file,time_pause )
...
%1st HTTP POST THE ANAGLYPH IMAGE (please replace the name of .jpg)
...
model1 = char(model);
model1 = model1(2:end);
modelname = strcat('http://gdo-appsdev.dsi.ic.ac.uk:8081/',model1,'-ana','.jpg');
